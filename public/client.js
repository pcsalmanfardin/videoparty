...
// The native <video>/browser Fullscreen API is unreliable on mobile — iOS Safari
// in particular does not support requestFullscreen() on a plain <div>. Instead
// of relying on it, we build our own "fill the screen" mode with plain CSS
// (position: fixed, covers the viewport). This behaves identically on laptop,
// Android, and iPhone, and keeps the emoji/message overlay visible everywhere.
...
fullscreenBtn.addEventListener("click", () => {
  setPseudoFullscreen(!playerArea.classList.contains("pseudo-fullscreen"));
});
